...
namespace Projeto_TS
{
    ...
    class ClientHandler
    {
        ...
        public void ThreadHandler()
        {
            ...
            try
            {
                ...
                while (true)
                {
                    try
                    {
                        ...
                        if (bytesRead == 0)
                        {
                            // Se nenhum byte for lido, a conexão foi encerrada
                            break;
                        }
            ...
            {
                // Fecho da networkStream e do cliente (TcpClient) no finally para garantir que os recursos são libertados
